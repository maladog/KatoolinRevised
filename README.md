...
# Requirements
- Python 2.7
- An operating system (tested on Ubuntu & Windows WSL Kali Linux)

# Installation
- sudo su
- git clone https://github.com/maladog/KatoolinRevised.git && cp katoolin/katoolin.py /usr/bin/katoolin
